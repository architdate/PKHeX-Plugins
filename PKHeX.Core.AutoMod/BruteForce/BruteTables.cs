...
namespace PKHeX.Core.AutoMod
{
    ...
    public static class BruteTables
    {
        ...
        public static Dictionary<int, int[]> GetRNGList(PIDType method)
        {
            if (method == PIDType.Method_2)
                return WC3RNGList_M2;
            if (method == PIDType.BACD_R)
                return WC3RNGList_BACD;
            throw new ArgumentException(nameof(method));
        }

        private static readonly Dictionary<int, int[]> WC3RNGList_M2 = new Dictionary<int, int[]>
        {
        ...
        private static readonly Dictionary<int, int[]> WC3RNGList_BACD = new Dictionary<int, int[]>
        {
