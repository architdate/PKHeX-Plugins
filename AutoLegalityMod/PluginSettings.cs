...
namespace AutoModPlugins
{
    public class PluginSettings
    {
        ...
        {
            EncounterTypeGroup.Egg, EncounterTypeGroup.Static,
        ...
        [Category(Miscellaneous)]
        [Description("Display legalization traceback for a particular Pokemon. Useful for debugging incorrectly generated sets.")]
