...
namespace com.google.zxing.qrcode.encoder
{
    ...
    public static class MatrixUtil
    {
        ...
        private static readonly int[][] POSITION_DETECTION_PATTERN = {new[]{1, 1, 1, 1, 1, 1, 1}, new[]{1, 0, 0, 0, 0, 0, 1}, new[]{1, 0, 1, 1, 1, 0, 1}, new[]{1, 0, 1, 1, 1, 0, 1}, new[]{1, 0, 1, 1, 1, 0, 1}, new[]{1, 0, 0, 0, 0, 0, 1}, new[]{1, 1, 1, 1, 1, 1, 1}};
        ...
        private static readonly int[][] HORIZONTAL_SEPARATION_PATTERN = {new[]{0, 0, 0, 0, 0, 0, 0, 0}};
        ...
        private static readonly int[][] VERTICAL_SEPARATION_PATTERN = {new[]{0}, new[]{0}, new[]{0}, new[]{0}, new[]{0}, new[]{0}, new[]{0}};
        ...
        private static readonly int[][] POSITION_ADJUSTMENT_PATTERN = {new[]{1, 1, 1, 1, 1}, new[]{1, 0, 0, 0, 1}, new[]{1, 0, 1, 0, 1}, new[]{1, 0, 0, 0, 1}, new[]{1, 1, 1, 1, 1}};
        ...
        private static readonly int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new[]{- 1, - 1, - 1, - 1, - 1, - 1, - 1}, new[]{6, 18, - 1, - 1, - 1, - 1, - 1}, new[]{6, 22, - 1, - 1, - 1, - 1, - 1}, new[]{6, 26, - 1, - 1, - 1, - 1, - 1}, new[]{6, 30, - 1, - 1, - 1, - 1, - 1}, new[]{6, 34, - 1, - 1, - 1, - 1, - 1}, new[]{6, 22, 38, - 1, - 1, - 1, - 1}, new[]{6, 24, 42, - 1, - 1, - 1, - 1}, new[]{6, 26, 46, - 1, - 1, - 1, - 1}, new[]{6, 28, 50, - 1, - 1, - 1, - 1}, new[]{6, 30, 54, - 1, - 1, - 1, - 1}, new[]{6, 32, 58, - 1, - 1, - 1, - 1}, new[]{6, 34, 62, - 1, - 1, - 1, - 1}, new[]{6, 26, 46, 66, - 1, - 1, - 1}, new[]{6, 26, 48, 70, - 1, - 1, - 1}, new[]{6, 26, 50, 74, - 1, - 1, - 1}, new[]{6, 30, 54, 78, - 1, - 1, - 1}, new[]{6, 30, 56, 82, - 1, - 1, - 1}, new[]{6, 30, 58, 86, - 1, - 1, - 1}, new[]{6, 34, 62, 90, - 1, - 1, - 1}, new[]{6, 28, 50, 72, 94, - 1, - 1}, new[]{6, 26, 50, 74, 98, - 1, - 1}, new[]{6, 30, 54, 78, 102, - 1, - 1}, new[]{6, 28, 54, 80, 106, - 1, - 1}, new[]{6, 32, 58, 84, 110, - 1, - 1}, new[]{6, 30, 58, 86, 114, - 1, - 1}, new[]{6, 34, 62, 90, 118, - 1, - 1}, new[]{6, 26, 50, 74, 98, 122, - 1}, new[]{6, 30, 54, 78, 102, 126, - 1}, new[]{6, 26, 52, 78, 104, 130, - 1}, new[]{6, 30, 56, 82, 108, 134, - 1}, new[]{6, 34, 60, 86, 112, 138, - 1}, new[]{6, 30, 58, 86, 114, 142, - 1}, new[]{6, 34, 62, 90, 118, 146, - 1}, new[]{6, 30, 54, 78, 102, 126, 150}, new[]{6, 24, 50, 76, 102, 128, 154}, new[]{6, 28, 54, 80, 106, 132, 158}, new[]{6, 32, 58, 84, 110, 136, 162}, new[]{6, 26, 54, 82, 110, 138, 166}, new[]{6, 30, 58, 86, 114, 142, 170}};
        ...
        private static readonly int[][] TYPE_INFO_COORDINATES = {new[]{8, 0}, new[]{8, 1}, new[]{8, 2}, new[]{8, 3}, new[]{8, 4}, new[]{8, 5}, new[]{8, 7}, new[]{8, 8}, new[]{7, 8}, new[]{5, 8}, new[]{4, 8}, new[]{3, 8}, new[]{2, 8}, new[]{1, 8}, new[]{0, 8}};
