...
namespace com.google.zxing.qrcode.detector
{
    ...
    /// </para>
    /// <para><p>This class is thread-safe but not reentrant. Each thread must allocate its own object.</p></para>
    ///
    /// </summary>
    /// <author>  Sean Owen
    /// </author>
    ...
    {
        internal BitMatrix Image { get; }

        internal ArrayList PossibleCenters { get; }
        ...
        internal const int MIN_SKIP = 3; // 1 pixel/module times 3 modules/center
        internal const int MAX_MODULES = 57; // support up to version 10 for mobile clients
        ...
        /// </param>
        /// <summary> true iff the proportions of the counts is close enough to the 1/1/3/1/1 ratios
        /// used by finder patterns to be considered a match
        /// </summary>
        internal static bool FoundPatternCross(int[] stateCount)
        {
        ...
        /// <summary> number of rows we could safely skip during scanning, based on the first
        ...
        /// <summary> true iff we have found at least 3 finder patterns that have been detected
