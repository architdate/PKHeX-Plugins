...
namespace com.google.zxing
{
    ...
    /// </author>
    public sealed class MultiFormatReader : IReader
    {
        ...
        public Hashtable Hints
        {
            set
            {
                ...
                bool tryHarder = value?.ContainsKey(DecodeHintType.TRY_HARDER) == true;
                ArrayList formats = value == null ? null : (ArrayList) value[DecodeHintType.POSSIBLE_FORMATS];
                readers = ArrayList.Synchronized(new ArrayList(10));
                if (formats != null)
                {
        ...
        private Result DecodeInternal(BinaryBitmap image)
        {
            ...
            {
                IReader reader = (IReader) readers[i];
                try
                {
