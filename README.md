...
## @Bappsack:
- [@Bappsack](https://github.com/kwsch): for providing the IPlugin interface in PKHeX, which allows loading of this project's Plugin DLL files. Also for the support provided in the support server.
- [@Bappsack](https://github.com/olliz0r): For developing and maintaining `sys-botbase` which is necessary for LiveHeX to work.
- [@Bappsack](https://github.com/Rino6357) and [@Bappsack](https://github.com/crzyc) for their help with the GitHub Wiki associated with this project!
- [@Bappsack](https://github.com/Lusamine) for all their help with stress testing the code with wacky sets!
- [@Bappsack](https://github.com/Bappsack) for his help on discord in voice chats!
- [@Bappsack](https://www.flaticon.com/): for their icons. Author credits (Those Icons, Pixel perfect)
