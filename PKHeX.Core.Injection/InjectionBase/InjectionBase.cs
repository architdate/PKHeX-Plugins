...
namespace PKHeX.Core.Injection
{
    public abstract class InjectionBase : PointerCache
    {
        ...
        private static readonly Dictionary<string, LiveHeXVersion[]> SupportedTitleVersions = new()
        {
            ...
            { Scarlet_ID, new[] { LiveHeXVersion.SV_v101, LiveHeXVersion.SV_v110, LiveHeXVersion.SV_v120, LiveHeXVersion.SV_v130 } },
            { Violet_ID, new[] { LiveHeXVersion.SV_v101, LiveHeXVersion.SV_v110, LiveHeXVersion.SV_v120, LiveHeXVersion.SV_v130 } },
        };
